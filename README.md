...
#### Task 7: Create an IAM role for an AWS EC2 to communicate effectively with S3. 
...
Search bar > EC2 > Instances > Launch instances > List S3 buckets name > Key pair > create new key pair > EC2toS3 name > default everything else > Create key pair > everything else default > Launch instance
